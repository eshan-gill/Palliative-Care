...
<html>
  ...
  <head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" href="images/favicon/final.png">
        ...
        <div class="header-top-area">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-3">
                        <div class="logo">
                             <img alt="" src="images/favicon/health.png">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        <div class="navigation-menu">
                            <div class="navbar">
                                ...
                                <li><a class="smoth-scroll" href="Health/Login.jsp">Login/SignUp</a>
                                        </li>
                                </ul>
                                    <ul class="nav navbar-nav navbar-right">
                                        <li class="active"><a class="smoth-scroll" href="healthindex.jsp">Home </a>
                                        </li>
          ...
          <div class="row">
                <div class="col-sm-12">
                    <div class="section-title">
                        ...
                        <p>We are there for you for every generation</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
               ...
               <p>EClinical is a misson to provide quality health care to people receiving government assistance..</p>
               </div>
              </div>
                    ...
                    <strong>Medicare</strong>
                     ...
                     <strong>Marketplace</strong>
                      ...
                      <strong> Medical Clinics</strong>
                       ...
                       <strong>Medicaid Solutions</strong>
        ...
        <div class="container">
            ...
            <div class="col-md-12">
             ...
             <div class="col-md-12 uipasta-credit">
                <p>Design By <a href="http://www.uipasta.com" target="_blank" title="UiPasta">HealthCare</a></p>
                </div>
